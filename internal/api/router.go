...
func NewRouter(s store.Store, uploadDir string, transcriber ingest.Transcriber, chunker *ingest.Chunker, idx *search.HybridIndex, stitcher stitch.Stitcher) http.Handler {
	r := chi.NewRouter()
